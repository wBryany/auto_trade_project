...
if(reportTradeHeader&&reportTradeHeader.children[1]){reportTradeHeader.children[1].textContent='交易平台';reportTradeHeader.children[1].insertAdjacentHTML('afterend','<th data-environment-column>平台与环境</th>')}
